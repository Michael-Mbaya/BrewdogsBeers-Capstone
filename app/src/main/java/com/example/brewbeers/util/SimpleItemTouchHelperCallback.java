package com.example.brewbeers.util;

import androidx.recyclerview.widget.ItemTouchHelper;
import androidx.recyclerview.widget.RecyclerView;

public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    private final com.example.brewbeers.util.ItemTouchHelperAdapter mAdapter;
    ...
    public SimpleItemTouchHelperCallback(com.example.brewbeers.util.ItemTouchHelperAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder instanceof com.example.brewbeers.util.ItemTouchHelperViewHolder) {

                //  This tells the viewHolder that an item is being moved or dragged:

                com.example.brewbeers.util.ItemTouchHelperViewHolder itemViewHolder = (com.example.brewbeers.util.ItemTouchHelperViewHolder) viewHolder;
